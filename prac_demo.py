...
def email_pipeline(service, recipients, email_templates, log_filename):
    ...
    if st.button("Start Email Pipeline"):
        if "service" not in st.session_state:
            ...
            try:
                ...
                email_pipeline(st.session_state.service, st.session_state.recipients, email_templates, log_filename)
